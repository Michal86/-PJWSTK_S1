...
public class GUI extends JFrame implements Runnable {
    ...
    private void guiInit() {
        Weather weather = new Weather(service.country);
        weather.initialize(service.getWeather(service.city), service.currency);
        int width = 1024;
        int height = 768;
    ...
    private void initializeWeatherTab(JComponent topTab, JTabbedPane tabbedPane, Weather weather) {
        ...
        String strExRate = "1 " + weather.getCurrencyCode() + " = " + service.getRateFor(service.getCustomCurrency()) + " " + service.getCustomCurrency();
        ...
        String strNBPRate = "1 " + weather.getCurrencyCode() + " = " + service.getNBPRate() + " PLN";
